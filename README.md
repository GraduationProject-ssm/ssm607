...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=7)


# 绪论
## 1.1 选题背景
当人们发现随着生产规模的不断扩大，人为计算方面才是一个巨大的短板，所以发明了各种计算设备，从结绳记事，到算筹，以及算盘，到如今的计算机，都是在无法满足生产的前提下出现的。随着计算机的发展，又出现了互联网技术。到现在为止，互联网已经发展了几十年了，在几十年的时间里就已经风靡世界。各行各业都发现了计算机的好处，计算机刚开始是军用的，后来在民用行业开始使用，到互联网时代，各种行业信息如井喷一般充斥着互联网，信息产生和传播的速度不断的提高。针对互联网的优点，结合互联网，对传统行业信息处理技术进行升级是非常有必要的。本课题对于家政公司服务信息的管理方面，开发一个家政公司服务平台，在信息管理方面不至于混乱，也能降低数据的出错率，数据安全方面也有了保证，该系统还有其他的优点，比如优化信息处理流程，降低信息泄露风险，减少资金投入，产出更高，让管理人员的工作更有效率等。所以说，家政公司服务平台是目前不可缺的，对使用者相当的重要。
## 1.2 选题意义
如今的年代，已经是步入信息社会了，不仅信息更新速度频繁，信息量也大，在信息时代必须有相应的处理信息的方法，如果还采用以前的结绳记事或者笔写纸记，不仅是信息录入效率上赶不上节奏，在信息检索的速度上更是让人无法承受。幸而当今社会上计算机技术发展的相当不错，可以通过计算机在信息处理上面实现自动化或者半自动化的作业，采用计算机技术，能有效的提高信息录入以及信息检索的效率，社会上相同行业之间本身就是效率高的淘汰效率低的，既然采用计算机来替代手工记录，必然是效率更高，稳定性更强，成本更低等诸多优点。针对于家政公司服务信息管理，开发一个家政公司服务平台不仅可以实现现代化的信息管理，也更符合现代化信息管理规范。

在实际的使用效果中，家政公司服务平台的意义如下：

第一点：家政公司服务平台的出现，就是为了提高工作人员的效率，能够在规定时间完成工作任务。
...
# 3 系统分析
对于家政公司服务平台开发设计到的流程有，分析系统的功能，设计系统的结构，设计数据库，编码以及测试，其中，在系统分析中，所做的工作包括功能的确定，性能的分析等。
## 3.1 可行性研究
家政公司服务平台开发实现分析需要从不同的角度来进行分析可行性，比如从时间角度，经济角度，甚至操作角度。从不同的角度分析可行性会让家政公司服务平台开发具体化，进而达到辩证开发的正确性。
### 3.1.1 经济可行性
从经济方面分析是第一要素，没有经济的支持，任何项目都如水中捞月，无法实现。实现家政公司服务平台，开发过程不需要额外的经济条件，用本人现有的计算机就可以实现，这方面不需要额外的支出。
### 3.1.2 时间可行性
家政公司服务平台设计主要作为毕业设计，在题目确定之后，答辩之前使用的项目，对不同的开发进度上面都有时间的要求，总不至于答辩完成后才能实现功能，这个肯定不行，所以从时间上来分析项目的工作量，发现是可行的，符合正常开发时间。
### 3.1.3 操作可行性
...
家政公司服务平台把操作该系统的用户群分为三类，即管理员，员工，用户。

管理员对于家政公司服务平台操作的功能包括管理员工，管理基础数据，管理用户，管理家政服务，回复家政服务留言，管理家政服务订单，管理家政服务收藏等。其用例图如图3.4所示：

![](/md/blog.004.png)

图3.4 管理员用例图

员工对于家政公司服务平台操作的功能包括更改密码和个人信息，管理家政服务信息等。其用例图如图3.5所示：

![](/md/blog.005.png)

图3.5 员工用例图

用户对于家政公司服务平台操作的功能包括预约家政服务，管理家政服务订单，收藏家政服务，对家政服务留言等。其用例图如图3.6所示：
...
## 4.2 功能模块设计
对管理员具体功能的设计结果将以图4.1所示的管理员功能结构图来进行体现。管理员对于家政公司服务平台操作的功能包括管理员工，管理基础数据，管理用户，管理家政服务，回复家政服务留言，管理家政服务订单，管理家政服务收藏等。

![](/md/blog.007.png)

图4.1 管理员功能结构图

对员工具体功能的设计结果将以图4.2所示的员工功能结构图来进行体现。员工对于家政公司服务平台操作的功能包括更改密码和个人信息，管理家政服务信息等。

![](/md/blog.008.png)

图4.2 员工功能结构图

对用户具体功能的设计结果将以图4.3所示的用户功能结构图来进行体现。用户对于家政公司服务平台操作的功能包括预约家政服务，管理家政服务订单，收藏家政服务，对家政服务留言等。
...
（1）家政服务包括的属性有服务名称，服务介绍等。其属性图如下。

![](/md/blog.010.png)

图4.4 家政服务实体属性图

（2）家政服务订单包括的属性有服务地址，订单类型，订单号等。其属性图如下。

![](/md/blog.011.png)

图4.5 家政服务订单实体属性图

（3）管理员包括的属性有密码，用户名等。其属性图如下。
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|jiazhengfuwu\_name|服务名称 |varchar(200)|是|
|jiazhengfuwu\_photo|服务照片|varchar(200)|是|
|jiazhengfuwu\_types|家政服务类型 |int(11)|是|
|jiazhengfuwu\_old\_money|服务原价/小时|decimal(10,2)|是|
|jiazhengfuwu\_new\_money|现价/小时![打开新的 phpMyAdmin 窗口](/md/blog.015.png "打开新的 phpMyAdmin 窗口")|decimal(10,2)|是|
|jiazhengfuwu\_clicknum|点击次数|int(11)|是|
|jiazhengfuwu\_content|服务介绍|text|是|
|shangxia\_types|是否上架|int(11)|是|
|jiazhengfuwu\_delete|逻辑删除|int(11)|是|
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|jiazhengfuwu\_id|家政服务|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|jiazhengfuwu\_collection\_types|类型|int(11)|是|
...
|jiazhengfuwu\_id|家政服务|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|jiazhengfuwu\_commentback\_text|评价内容|text|是|
...
|jiazhengfuwu\_id|家政服务|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|jiazhengfuwu\_liuyan\_text|留言内容|text|是|
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|jiazhengfuwu\_order\_uuid\_number|订单号 |varchar(200)|是|
|jiazhengfuwu\_lianxiren\_name|联系人|varchar(200)|是|
|jiazhengfuwu\_lianxiren\_phone|联系人电话|varchar(200)|是|
|jiazhengfuwu\_lianxiren\_address|服务地址|varchar(200)|是|
|jiazhengfuwu\_id|家政服务|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|yuangong\_id|员工|int(11)|是|
|buy\_number|小时|int(11)|是|
|jiazhengfuwu\_order\_true\_price|实付价格|decimal(10,2)|是|
|jiazhengfuwu\_order\_types|订单类型|int(11)|是|
|jiazhengfuwu\_order\_payment\_types|支付类型|int(11)|是|
...
|yuangong\_shanchang|擅长|varchar(200)|是|
|sex\_types|性别|int(11)|是|
|yuangong\_email|电子邮箱|varchar(200)|是|
|yuangong\_content|员工介绍|text|是|
|create\_time|创建时间|timestamp|是|
...
## 5.1 管理员功能实现
### 5.1.1 家政服务管理
该功能主要用于实现对家政服务基本信息的管理，家政服务管理界面的运行效果见图5.1。在此界面，管理员下架家政服务，上架家政服务，更改家政服务信息，查询家政服务信息等。
...
图5.2 用户管理界面
### 5.1.3 家政服务留言管理
该功能主要用于实现对家政服务留言基本信息的管理，家政服务留言管理界面的运行效果见图5.3。在此界面，管理员回复家政服务留言，查询家政服务留言，删除家政服务留言信息等。

![](/md/blog.018.png)

图5.3 家政服务留言管理界面
### 5.1.4 家政服务订单管理
该功能主要用于实现对家政服务订单基本信息的管理，家政服务订单管理界面的运行效果见图5.4。在此界面，管理员为预定家政服务的用户安排家政服务，根据订单号查询家政服务订单，删除家政服务订单等。
...
## 5.2 员工功能实现
### 5.2.1 家政服务管理
该功能主要用于实现对家政服务基本信息的管理，家政服务管理界面的运行效果见图5.5。在此界面，员工查询家政服务信息，员工点击信息显示栏右侧的详情按钮可以查看家政服务详细介绍。

![](/md/blog.020.png)

图5.5 家政服务管理界面
### 5.2.2 个人信息
该功能主要用于实现对个人基本信息的管理，个人信息界面的运行效果见图5.6。在此界面，员工对个人信息进行更改或查看，更改个人信息也包括更改个人介绍，电话等信息。
...
## 5.3 用户功能实现
### 5.3.1 家政服务
家政服务界面的运行效果见图5.7。在此界面，用户收藏家政服务，查看界面下方的家政服务相关评论信息以及可以发布家政服务的留言，用户如果需要家政服务，可以点击立即预约按钮及时预约家政服务。

![](/md/blog.022.png)

图5.7 家政服务界面
### 5.3.2 预约家政服务
预约家政服务界面的运行效果见图5.8。在此界面，用户登记个人联系方式，包括手机，服务地址等，选择预约时间即可提交。

![](/md/blog.023.png)

图5.8 预约家政服务界面
### 5.3.3 家政服务订单
家政服务订单界面的运行效果见图5.9。在此界面，用户可以退款，可以选择确认服务等操作。
